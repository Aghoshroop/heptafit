  ...
  return (
    <div className="h-[calc(100vh-120px)] flex flex-col max-w-[1600px] mx-auto pb-6">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground mt-1">Direct messaging with your coaches.</p>
      </div>
        ...
        <div className="w-80 border-r border-white/10 flex flex-col bg-black/20">
          <div className="p-4 border-b border-white/10">
            <div className="relative">
              ...
              <Input className="pl-9 bg-white/5 border-none" placeholder="Search coaches..." />
            </div>
          </div>
            ...
            {coaches.map((coach: any) => (
              ...
              >
                ...
                <div className="overflow-hidden">
                  <p className="font-semibold truncate">{coach.firstName} {coach.lastName}</p>
          ...
          {!activeChat ? (
            <div className="flex-1 flex items-center justify-center">
              <EmptyState 
                ...
                title="Your Messages"
                description="Select a coach to start a conversation."

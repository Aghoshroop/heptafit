...
export function TrainingPlanSummary() {
  ...
  return (
    <div className="bg-card rounded-xl p-5 border border-border flex-1 flex flex-col min-h-[220px]">
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-sm font-semibold text-foreground">Training Plan Summary</h3>
      ...
      <div className="flex-1 flex items-center justify-between">
        <div className="w-[120px] h-[120px] relative shrink-0">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
            ...
            <span className="text-[9px] text-muted-foreground text-center px-2 leading-tight">Active Plans</span>
          </div>
        </div>

        <div className="flex-1 ml-6 flex flex-col justify-center gap-2">
          <div className="flex items-center justify-between text-[9px] text-muted-foreground uppercase tracking-wider font-bold mb-1">
          ...
          {data.map((item, i) => (
            <div key={i} className="flex items-center justify-between text-xs">
              <div className="flex items-center gap-2">
                ...
                <span className="text-foreground text-[11px] truncate w-24">{item.name}</span>
              </div>
              <div className="flex items-center gap-2">
